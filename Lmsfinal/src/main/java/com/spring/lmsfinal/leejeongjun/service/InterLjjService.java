...
public interface InterLjjService {
...
/////////////휴학신청 파트 시작//////////////////////////////////////////////////
	...
	// 일반휴학 신청하기(트랜잭션처리)
	int leaveAdd(Leave_schoolVO leaveschoolvo, String stdstateid) throws Throwable;

	// 첨부파일 있는 군휴학 신청하기(트랜잭션처리)
	int leaveArmyAdd(Leave_armyVO leavearmyvo, String stdstateid) throws Throwable;
	...
	// 휴학신청 취소하기(트랜잭션처리)
	int delLeave(Map<String, String> paraMap) throws Throwable;
	...
	// 복학신청하기(파일첨부x 트랜잭션처리)
	int addReturnSchool(Map<String, String> paraMap) throws Throwable;
	...
	// 복학신청취소하기(트랜잭션처리)
	int delreturn(Map<String, String> paraMap) throws Throwable;

	// 복학신청하기(파일첨부O 트랜잭션처리)
	int add_returnAttach(Return_schoolVO returnschoolvo, String stdstateid) throws Throwable;
