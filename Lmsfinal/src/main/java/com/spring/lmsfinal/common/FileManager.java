...
public class FileManager {
	...
	public String doFileUpload(byte[] bytes, String originalFilename, String path) throws Exception {
		...
		newFilename += fileExt;
		// newFilename 은 예를 들면, 2022042912181535243254235235234.png 와 같이 된다.   
		...
		// pathname 은 예를 들면, C:\NCS\workspace(spring)\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\Board\resources\files\2022042912181535243254235235234.png 이다.      
