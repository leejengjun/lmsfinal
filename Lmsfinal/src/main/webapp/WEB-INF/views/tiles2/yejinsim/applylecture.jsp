...
<div style="margin: auto; margin-left: 250px; padding-left: 3%; margin-top: 3%;">
	...
	<form name="searchFrm" style="margin-top: 20px;">
      ...
      <select name="searchType" id="searchType" style="height: 26px;">
         ...
         <option value="subjectid">강의번호</option>
      </select>
   ...
   <div id="displayList" style="border:solid 1px gray; border-top:0px; height:100px; margin-left:95px; margin-top:-1px; overflow:auto;">
   	안녕~
   </div>
