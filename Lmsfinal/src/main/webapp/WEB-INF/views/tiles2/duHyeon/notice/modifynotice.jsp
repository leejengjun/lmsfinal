	...
	$(document).ready(function(){
		...
		$("button#btnWrite").click(function(){
	       ...
	       <%-- === 스마트에디터 구현 끝 === --%>
			...
			frm.method = "POST";
			frm.action = "<%=ctxPath%>/modifynoticeEnd.lmsfinal";
			frm.submit();
		});
...
<form name = "addNoticeFrm" enctype = "multipart/form-data">
	<table style = "width: 1024px" class = "table table-bordered">
		...
		<tr>
			...
			<td>
				<input type = "text" name = "snsubject" id = "snsubject" size = "100" value="${requestScope.noticevo.snsubject}"/>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<textarea style = "width: 100%; height: 612px;" name = "sncontent" id = "sncontent">${requestScope.noticevo.sncontent}</textarea>
			</td>
		</tr>
	...
	<input type="hidden" id="pastsnpwd"value="${requestScope.noticevo.snpwd}"/>
	<input type="hidden" name="subnoticeno" value="${requestScope.noticevo.subnoticeno}"/>
	<div style = "margin: 20px; text-align: center;">
		<button type = "button" class = "btn btn-secondary btn-lg mr-3" id = "btnWrite">수정하기</button> 
