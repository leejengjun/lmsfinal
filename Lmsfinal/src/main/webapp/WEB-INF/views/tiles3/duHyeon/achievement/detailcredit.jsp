...
<script type="text/javascript">
	...
	function compute(){
		...
		if($("input#taskscore").val() > 100){
			
			alert("과제점수는 100점을 넘길수 없습니다.");
		...
		$.ajax({
            ...
            success:function(json){
            	...
            	$("input#attscore").val((Number($("input#attscore").val()) * lpattendper).toFixed(2));
            	$("input#midscore").val((Number($("input#midscore").val()) * lpexamper).toFixed(2));
            	$("input#finalscore").val((Number($("input#finalscore").val()) * lpexamper).toFixed(2));
            	$("input#taskscore").val((Number($("input#taskscore").val()) * lphomewkper).toFixed(2));
